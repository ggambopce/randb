...
class PostServiceImplTest {
    ...
    void delete_fail() {
        ...
        assertThrows(NoSuchElementException.class, () -> postService.delete("강진호",1L));
    ...
    void update() {
        ...
        postService.update(1L, updateRequest, "강진호");
    ...
    void update_fail() {
        ...
        assertThrows(NoSuchElementException.class, () -> postService.update(1L, updateRequest, "강진호"));
