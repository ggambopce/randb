package com.jinho.randb.domain.post.exception.advice;

import com.jinho.randb.domain.post.exception.PostErrorResponse;
import com.jinho.randb.domain.post.exception.ex.AccessDeniedPostException;
import com.jinho.randb.domain.post.exception.ex.InvalidPostRequestException;
import com.jinho.randb.domain.post.exception.ex.PostNotFoundException;
import com.jinho.randb.domain.post.exception.ex.UnauthorizedPostException;
