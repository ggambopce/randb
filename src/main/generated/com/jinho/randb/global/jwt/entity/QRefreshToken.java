...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = -41091187L;
    ...
    public final DateTimePath<java.time.LocalDateTime> tokenTime = createDateTime("tokenTime", java.time.LocalDateTime.class);
